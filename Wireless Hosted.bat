...
REM
REM
echo -- Make sure that you run the script "As Administrator"
echo --
set /p ok= -- When ready hit enter:
adb kill-server
netsh wlan stop hostednetwork
echo --  Starting a Hosted Network called: AndroidDev
netsh wlan set hostednetwork mode=allow SSID=AndroidDev key=wireless!
...
echo --  Your key for "AndroidDev" is "wireless!"
